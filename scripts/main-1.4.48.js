...
import { FighterAutomationService } from "./combat/fighter-automation-service.js?v=1.4.48";
...
import { registerSceneControlsHook } from "./hooks.js?v=1.4.48";
import {
  extendDnd5eItemTypes,
  registerDnd5eSheetExtensions,
  registerRebreyaWeaponBaseItemsFromGearPack
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.48";
...
export class RebreyaMainModule {
  ...
  async openInventoryApp(options = {}) {
    try {
      const moduleVersion = game.modules?.get?.(MODULE_ID)?.version ?? "1.4.48";
