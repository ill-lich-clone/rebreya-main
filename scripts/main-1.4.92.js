...
import { GearCompendiumService } from "./data/gear-compendium.js?v=1.4.92-firearm-template-version-18";
...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.92-firearm-item-sheet-no-rerender";
import { CombatAttackService } from "./combat/attack-service.js?v=1.4.92-firearm-canonical-misfire-repair";
import { registerRadialStatusEffects } from "./combat/radial-status-effects.js";
import { CombatStatusService, registerCombatStatusConfig } from "./combat/status-service.js?v=1.4.92-surrounded-ac";
import { AttackRollBoostService } from "./combat/attack-roll-boost-service.js?v=1.4.92";
import { EnvironmentAutomationService } from "./combat/environment-automation-service.js?v=1.4.92-environment-stable-statuses";
import { registerMechanusRollHooks } from "./cosmology/mechanus-rolls.js?v=1.4.92-mechanus-d20-advantage-mode";
import { FighterAutomationService } from "./combat/fighter-automation-service.js?v=1.4.92";
import {
  PaladinAutomationService,
  SOCKET_EVENT_CHARACTER_CLASS_AUTOMATION
} from "./combat/paladin-automation-service.js?v=1.4.92";
import { RogueAutomationService } from "./combat/rogue-automation-service.js?v=1.4.92-rebreya-open-position";
import { PerformerAutomationService } from "./combat/performer-automation-service.js?v=1.4.92";
import { RaceAutomationService, SOCKET_EVENT_RACE_AUTOMATION } from "./combat/race-automation-service.js";
import { registerSceneControlsHook } from "./hooks.js?v=1.4.92-bg3-piles";
import {
  extendDnd5eItemTypes,
  registerDnd5eSheetExtensions,
  registerRebreyaWeaponBaseItemsFromGearPack
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.92-libwrapper-heroic-d20";
...
import { registerMagicWeaponTemplateHook } from "./integrations/magic-weapon-template.js?v=1.4.92";
import { patchTransformCleanupUpdateActorHook } from "./integrations/transform-cleanup-compat.js";
import { registerForienQuestLogIntegration, refreshForienQuestLogApps } from "./integrations/forien-quest-log.js?v=1.4.92";
import {
...
const MODULE_STYLE_VERSION = "1.4.92-cosmology";
...
export class RebreyaMainModule {
  ...
  async openCosmologyApp() {
    try {
      ...
      const { CosmologyApp } = await import("./ui/cosmology-app.js?v=1.4.92-cosmology");
