...
export const CRAFTSMAN_CONSTRUCT_DOCUMENT_ID = "lchconstruct0001";
export const CRAFTSMAN_CONSTRUCT_UUID = `Compendium.world.${CRAFTSMAN_CONSTRUCTS_COMPENDIUM_NAME}.Actor.${CRAFTSMAN_CONSTRUCT_DOCUMENT_ID}`;
export const CRAFTSMAN_CONSTRUCT_TOKEN_PATH = `modules/${MODULE_ID}/templates/icons/Classes/Craftsman/construct-token.webp`;
