...
} from "./magic-item-embedded-sync.js?v=1.4.188-rarity-magic-item-automation";
...
const MAGIC_ITEM_AUTOMATION_VERSION = 2;
...
const NATIVE_MAGIC_ITEM_BONUSES = new Map([
  ...
  ["непенте", 3], ["лунный-серп-1", 1], ["лунный-серп-2", 2], ["лунный-серп-3", 3]
]);
