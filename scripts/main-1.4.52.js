...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.52";
...
export class RebreyaMainModule {
  ...
  async openInventoryApp(options = {}) {
    try {
      const moduleVersion = game.modules?.get?.(MODULE_ID)?.version ?? "1.4.52";
