...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.76";
...
import { AttackRollBoostService } from "./combat/attack-roll-boost-service.js?v=1.4.76";
import { FighterAutomationService } from "./combat/fighter-automation-service.js?v=1.4.76";
import {
  PaladinAutomationService,
  SOCKET_EVENT_CHARACTER_CLASS_AUTOMATION
} from "./combat/paladin-automation-service.js?v=1.4.76";
import { RogueAutomationService } from "./combat/rogue-automation-service.js?v=1.4.76";
import { PerformerAutomationService } from "./combat/performer-automation-service.js?v=1.4.76";
import { RaceAutomationService, SOCKET_EVENT_RACE_AUTOMATION } from "./combat/race-automation-service.js";
import { registerSceneControlsHook } from "./hooks.js?v=1.4.76";
import {
  extendDnd5eItemTypes,
  registerDnd5eSheetExtensions,
  registerRebreyaWeaponBaseItemsFromGearPack
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.76";
...
import { registerMagicWeaponTemplateHook } from "./integrations/magic-weapon-template.js?v=1.4.76";
