...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.86";
import { CombatAttackService } from "./combat/attack-service.js?v=1.4.86-midi-workflow-damage";
...
import { AttackRollBoostService } from "./combat/attack-roll-boost-service.js?v=1.4.86";
import { FighterAutomationService } from "./combat/fighter-automation-service.js?v=1.4.86";
import {
  PaladinAutomationService,
  SOCKET_EVENT_CHARACTER_CLASS_AUTOMATION
} from "./combat/paladin-automation-service.js?v=1.4.86";
...
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.86";
...
import { registerMagicWeaponTemplateHook } from "./integrations/magic-weapon-template.js?v=1.4.86";
...
const MODULE_STYLE_VERSION = "1.4.86";
