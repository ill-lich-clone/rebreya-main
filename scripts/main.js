...
import { clearNamedIconCache } from "./data/compendium-utils.js?v=1.4.323";
import { MaterialsCompendiumService } from "./data/materials-compendium.js?v=1.4.323";
import { GearCompendiumService } from "./data/gear-compendium.js?v=1.4.323";
import { repairWorldAmmunitionCompatibility } from "./data/ammunition-compatibility.js?v=1.4.147-native-ammunition";
import { MagicItemsCompendiumService } from "./data/magic-items-compendium.js?v=1.4.323";
import { FeatsCompendiumService } from "./data/feats-compendium.js?v=1.4.323";
import { GlossaryCompendiumService } from "./data/glossary-compendium.js?v=1.4.323";
import { BackgroundsCompendiumService } from "./data/backgrounds-compendium.js?v=1.4.323";
import { StatesCompendiumService } from "./data/states-compendium.js?v=1.4.323";
import { RacesCompendiumService } from "./data/races-compendium.js?v=1.4.323";
import { ClassesCompendiumService } from "./data/classes-compendium.js?v=1.4.323";
import { CraftsmanConstructCompendiumService } from "./data/craftsman-construct-compendium.js";
import { TransportCompendiumService } from "./data/transport-compendium.js?v=1.4.323";
import {
...
import { SpellsCompendiumService } from "./data/spells-compendium.js?v=1.4.323";
import { ActionsCompendiumService } from "./data/actions-compendium.js?v=1.4.323";
import { DowntimeCompendiumService } from "./data/downtime-compendium.js?v=1.4.323";
...
import { TraderService, normalizeTraderState } from "./data/trader-service.js?v=1.4.323";
...
} from "./data/inventory-service.js?v=1.4.323";
import {
...
import { registerInventorySyncHooks } from "./integrations/inventory-sync.js?v=1.4.323";
...
import { registerMagicWeaponTemplateHook } from "./integrations/magic-weapon-template.js?v=1.4.323";
...
export class RebreyaMainModule {
  ...
  async openInventoryApp(options = {}) {
    try {
      const { InventoryApp } = await import("./ui/inventory-app.js?v=1.4.323");
