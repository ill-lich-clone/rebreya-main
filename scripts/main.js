...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.57";
...
import { FighterAutomationService } from "./combat/fighter-automation-service.js?v=1.4.57";
import {
...
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.57";
...
export class RebreyaMainModule {
  ...
  async openInventoryApp(options = {}) {
    try {
      const moduleVersion = game.modules?.get?.(MODULE_ID)?.version ?? "1.4.57";
