...
import { registerCombatHooks } from "./combat/hooks.js?v=1.4.91-firearm-item-sheet-no-rerender";
import { CombatAttackService } from "./combat/attack-service.js?v=1.4.91-firearm-canonical-misfire-repair";
