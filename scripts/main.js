...
} from "./integrations/dnd5e-sheet-extensions.js?v=1.4.302";
...
import { registerMagicWeaponTemplateHook } from "./integrations/magic-weapon-template.js?v=1.4.308";
...
const MODULE_STYLE_VERSION = "1.4.308";
