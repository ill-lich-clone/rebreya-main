...
[R1 — дополнительные окна и UI куклы](2026-09-07-module-development/r1-overlays-hero-ui.md). R0 реализован и проверен; сохранять отдельный scope и Git-цикл каждого следующего этапа, продолжая в текущей задаче по указанию пользователя.
