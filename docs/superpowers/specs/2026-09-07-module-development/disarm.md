...
Для квадратной сетки: к8, 1=север, далее по часовой стрелке СВ/В/ЮВ/Ю/ЮЗ/З/СЗ/З. У крупного токена берётся ближайшая внешняя клетка по выбранному направлению от footprint; используется реальная grid size сцены.
