...
До R1 HBS печатал itemName/itemMeta внутри слота и native title; размер зависел от содержимого. R1 реализован в 1.4.247: фиксированные ячейки и общий tooltip; мутации экземпляров остаются этапом R3.

## R1: внешний вид

- Все ячейки имеют одинаковый фиксированный размер в одном layout mode, независимо от имени/метаданных/пустоты. Реализованная база — 80×80 CSS px; сетка адаптируется числом колонок, не растягиванием конкретной ячейки.
