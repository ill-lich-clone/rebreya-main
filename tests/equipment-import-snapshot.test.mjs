...
test("production registry covers the approved spreadsheet and canonical special ammunition", () => {
  ...
  assert.equal(SHEET_REGISTRY.baseGear.range, "A1:N1200");
...
test("production workbook snapshot retains late furniture, fishing rods, and bait", () => {
