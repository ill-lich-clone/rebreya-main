...
export const MAGIC_ITEMS = [
  ...
  },
  {
    ...
    "bargaining": "Удачные",
    "costText": "10000 зм",
    "description": "Этот кусок аметиста размером с кулак наделен способностью аметистового дракона преодолевать гравитацию. \nБонусным действием вы можете потратить заряд, чтобы получить способность летать в течение 10 минут. На это время вы получаете скорость полёта, равную вашей скорости ходьбы, и можете парить.",
  ...
  },
  {
    ...
    "bargaining": "Удачные",
    "costText": "10000 зм",
    "description": "Вы получаете бонус +2 к броскам атаки и урона, совершённым этим магическим оружием. Оно имеет следующие свойства:\nКогда вы наносите критический удар по существу, вы можете потратить 1 заряд боевой кирки, чтобы это существо совершило спасбросок Телосложения со Сл 15. При провале спасброска существо становится окаменевшим на 8 часов. Когда у боевой кирки кончаются заряды, она теряет это свойство. Кирка не восстанавливает заряды.",
  ...
  },
  {
    ...
    "bargaining": "Нормальные",
    "costText": "(1d8+1)*5000 зм",
    "description": "У этой волшебной палочки 6 зарядов. Если вы её держите, вы можете действием потратить 1 заряд, чтобы наложить ей заклинание превращение [polymorph] (Сл спасброска 15).",
  ...
  },
  {
    ...
    "bargaining": "Выгодные",
    "costText": "(2d8kl1+1)*5000 зм",
    "description": "Пока вы носите этот доспех, вы получаете бонус +3 к КД, можете говорить на языке Бездны и понимаете этот язык. Кроме того, латные рукавицы с шипами этого доспеха делают ваши безоружные атаки руками магическим оружием, причиняющим рубящий урон с бонусом +3 к броскам атаки и урона и костью урона 2к8.\n\nПроклятье. Надев этот проклятый доспех, вы не можете его снять, пока не станете целью заклинания снятие проклятья [remove curse] или подобной магии. Нося этот доспех, вы совершаете с помехой броски атаки по демонам и спасброски от заклинаний и особых умений демонов.",
  ...
  },
  {
    ...
    "bargaining": "Невозможные",
    "costText": "",
    "description": "Пока вы носите эти доспехи, вы можете использовать их для наложения заклинания преграда магии [antimagic field], не требуя компоненты заклинания. Как только это свойство будет использовано, его нельзя будет использовать снова до следующего рассвета.",
    "id": "доспех-антимагии",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Грудь",
  ...
  },
  {
    ...
    "bargaining": "Нормальные",
    "costText": "(1d8+1)*5000 зм",
    "description": "Этот доспех изготавливается из чешуи определённого дракона. Иногда драконы сами собирают сброшенные чешуйки и дарят их гуманоидам. В других случаях успешные охотники тщательно выделывают и хранят шкуры убитых драконов. В любом случае, доспехи из чешуи драконов высоко ценятся.\n\nПока вы носите этот доспех, вы получаете бонус +2 к КД, совершаете с преимуществом спасброски от Ужасающей внешности и оружия дыхания драконов, а также обладаете сопротивлением одному виду урона, зависящему от вида дракона, чья чешуя была использована для изготовления доспеха (спросите мастера про виды драконов).",
  ...
  },
  {
    ...
    "bargaining": "Нормальные",
    "costText": "(1d8+1)*2500 зм",
    "description": "Пока вы носите этот мягко мерцающий доспех, вы получаете бонус +2 к КД.\n\nЕсли вы умираете, будучи облаченным в этот доспех, он ломается, и каждый небожитель, фея и исчадие в радиусе 30 футов от вас изгнаняется на свой родной план существования, если только он уже не находится там.",
  ...
  },
  {
    ...
    "bargaining": "Невыгодные",
    "costText": "(2d8kh1+1)*5000 зм",
    "description": "Вы получаете бонус +2 к броскам атаки и урона, совершённым этим крючковатым обсидиановым кинжалом.\n\nКогда вы попадаете по существу этим магическим оружием, то, при критическом попадании, существо должно совершить спасбросок Телосложения со Сл 15, поскольку кинжал вспыхивает болезненным светом. Существо получает 6к6 урона некротической энергией при провале или половину этого урона при успехе. Если этот урон снижает хиты существа до 0, существо рассыпается в пыль.",
    "id": "зловещий-коготь",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Рука",
  ...
  },
  {
    ...
    "bargaining": "Нормальные",
    "costText": "(1d8+1)*5000 зм",
    "description": "Это оружие выглядит обычным, но оно несет в себе сильную магию иллюзий, которая позволяет его владельцу умело обманывать противников.\n\nЭто оружие выглядит обычным, но оно несёт в себе сильную магию иллюзий, которая позволяет его владельцу умело обманывать противников.\n\nВы получаете бонус +2 к броскам атаки и урона, совершённым этим магическим оружием. Держа этот меч, вы получаете следующие преимущества:\n\nНеверное направление\nКогда существо в пределах 60 футов от вас нацеливается на вас броском атаки, вы можете своей реакцией потребовать от этого существа нацелиться на другое существо по вашему выбору, находящееся в пределах досягаемости атакующего. После того как эта реакция будет использована, её нельзя будет использовать снова до следующего рассвета.",
    "id": "клинок-дурака",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Рука",
  ...
  },
  {
    ...
    "bargaining": "Удачные",
    "costText": "10000 зм",
    "description": "Эта колода карт из плотной бумаги наполнена магией Стихийного Хаоса.\n\nМагия колоды действует только в том случае, если карты взяты случайным образом (колода реальных игральных карт может имитировать колоду). Действием вы можете взять случайную карту из этой колоды и метнуть её, чтобы совершить дальнобойную атаку заклинанием, используя Ловкость для броска атаки. Дистанция карты 30 футов. При попадании она наносит 1к4 рубящего урона и накладывает магический эффект, определяемый её мастью, как подробно описано в таблице \"Колода диких карт\". Карта немедленно возвращается в колоду после того, как попадает или промахивается по цели.\n\nКолода диких карт\n| к4 | Масть | Эффект |\n| --- | --- | --- |\n| 1 | ♣ (Жезлы) | Карта взрывается вспышкой огня. Цель и каждое существо в пределах 5 футов от неё должны совершить спасбросок Ловкости Сл 15, иначе получит 2к8 урона огнём. |\n| 2 | ♦ (Монеты) | Карта обращается полосами молний. Цель должна совершить спасбросок Ловкости Сл 15. При провале цель становится ослеплённой до конца вашего следующего хода, и каждое существо в пределах 10 футов от цели получает 1к6 урона электричеством. |\n| 3 | ♥ (Чаши) | Карта покрывает цель толстым слоем льда. Цель получает 1к10 урона холодом и должна преуспеть в спасброске Телосложения Сл 15, иначе станет опутанной до конца вашего следующего хода. |\n| 4 | ♠ (Мечи) | Карта издает пронзительный, оглушительный взрыв. Цель и каждое существо в пределах 5 футов от неё получают 1к6 урона силовым полем и должны преуспеть в спасброске Силы Сл 15, иначе упадут ничком. |",
  ...
  },
  {
    ...
    "bargaining": "Нормальные",
    "costText": "(1d8+1)*5000 зм",
    "description": "Нося это кольцо в области тусклого света или темноте, вы можете неограниченно действием накладывать им пляшущие огоньки [dancing lights] или свет [light].\n\nПадающие звёзды. Вы можете действием потратить от 1 до 3 зарядов. За каждый потраченный заряд выберите видимую вами точку в пределах 120 футов. Все существа в пределах 10 футов от каждой точки должны совершить спасбросок Ловкости Сл 17. Провал:  10к8 урона огнём. Успех: половина этого урона.",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "600 зм",
    "description": "Это помело весит 3 фунта. Когда вы сядете на него верхом, используя 5 футов Передвижения и Бонусным Действием произнесёте командное слово, оно начнёт летать. Помело снова становится обычной метлой, когда вы перестаёте сидеть на нём верхом.\r\n\r\nУ помела Скорость Полёта 50 футов, но если вы использовали как минимум 5 футов его Передвижения, то в текущем Ходу вы уже не сможете использовать собственное Передвижение, кроме как для того, чтобы спешиться с помела, также используя 5 футов Передвижения и вы не сможете использовать Передвижение Помела Полёта в текущем Ходу, если уже использовали собственное Передвижение, кроме как для того, чтобы сесть на него верхом. \r\n\r\nЛетая на помеле существо должно держать его 1-й свободной рукой, а также оно вызывает Провоцированные Атаки. Если существо перестаёт держать помело, то оно сбрасывается с него и если существо Сбито с Ног, когда сидит верхом на помеле, то оно должно преуспеть в Спасброске Ловкости со сложностью 10 или также будет сброшено с него.\r\n\r\nЕсли сидящее на помеле существо Схвачено, то оно не может использовать Скорость помела для Передвижения, а схватившее существо может тащить или нести Схваченное существо вмести с помелом.\r\n\r\nПомело может поднимать до 400 фунтов, но начиная с веса 200 фунтов его Скорость уже уменьшается до 25-ти футов. Помело перестаёт летать, когда вы приземляетесь.\r\n\r\nЕсли помело никто не несёт и не носит вы можете отправить его в другое место, находящееся в пределах 1 мили, если Бонусным Действием произнесёте командное слово и назовёте место, которое вы видели. Помело вернётся к вам, когда вы снова произнесёте командное слово Бонусным Действием, при условии, что помело всё ещё находится в пределах 1 мили от вас и его всё также никто не несёт и не носит. Когда помело летит в указанное место или возвращается обратно, то оно летит по кратчайшему свободному маршруту, но облетает, если возможно, все препятствия и опасности, вроде стен или открытого пламени.",
    "id": "помело-полета",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Спина",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "300000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Мудрости увеличивается на 7, с максимумом в 25.",
    "id": "пояс-дракона-вирма",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "6000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Ловкости увеличивается на 4, с максимумом в 20.",
    "id": "пояс-ловкости-взрослой-феи",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс ловкости взрослой феи",
    "rank": 6,
    "rarity": "Редкий",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "45000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Ловкости увеличивается на 6, с максимумом в 20.",
    "id": "пояс-ловкости-древней-феи",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс ловкости древней феи",
    "rank": 8,
    "rarity": "Очень редкий",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "300000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Ловкости увеличивается на 7, с максимумом в 25.",
    "id": "пояс-ловкости-матриарха-фей",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс ловкости матриарха фей",
    "rank": 10,
    "rarity": "Легендарный",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "600 зм",
    "description": "Пока вы носите этот пояс, значение вашей Ловкости увеличивается на 2, с максимумом в 20.",
    "id": "пояс-ловкости-молодой-феи",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс ловкости молодой феи",
    "rank": 4,
    "rarity": "Необычный",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "6000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Мудрости увеличивается на 4, с максимумом в 20.",
    "id": "пояс-мудрости-взрослого-дракона",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс мудрости взрослого дракона",
    "rank": 6,
    "rarity": "Редкий",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "45000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Мудрости увеличивается на 6, с максимумом в 20.",
    "id": "пояс-мудрости-древнего-дракона",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс мудрости древнего дракона",
    "rank": 8,
    "rarity": "Очень редкий",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "600 зм",
    "description": "Пока вы носите этот пояс, значение вашей Мудрости увеличивается на 2, с максимумом в 20.",
    "id": "пояс-мудрости-молодого-дракона",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс мудрости молодого дракона",
    "rank": 4,
    "rarity": "Необычный",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "600 зм",
    "description": "Пока вы носите этот пояс, значение вашей Харизмы увеличивается на 2, с максимумом в 20.",
    "id": "пояс-харизмы-беса",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "45000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Харизмы увеличивается на 6, с максимумом в 20.",
    "id": "пояс-харизмы-исчадия-преисподней",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс харизмы исчадия преисподней",
    "rank": 8,
    "rarity": "Очень редкий",
    "source": "Lich",
    "type": "Магический предмет",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "300000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Харизмы увеличивается на 7, с максимумом в 25.",
    "id": "пояс-харизмы-тиамат",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
  ...
  },
  {
    ...
    "bargaining": "Провальные",
    "costText": "6000 зм",
    "description": "Пока вы носите этот пояс, значение вашей Харизмы увеличивается на 4, с максимумом в 20.",
    "id": "пояс-харизмы-черного-абишая",
    "impact": "Мажор",
    "isConsumable": false,
    "itemSlot": "Пояс",
    "itemSubtype": "",
    "itemType": "Чудесный предмет",
    "materials": "Труднодоступные",
    "name": "Пояс харизмы чёрного абишая",
    "rank": 6,
    "rarity": "Редкий",
    "source": "Lich",
    "type": "Магический предмет",
