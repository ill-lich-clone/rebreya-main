...
R7, версия 1.4.254: подключены 27 профилей — 12 пассивных и 15 оружейных (атака, преимущество, дополнительные типы урона и базовые кости священной стали). Бонусы оружия принадлежат конкретному предмету; условные эффекты требуют известных данных цели/атаки. Снятие или потеря условий активности убирает собственный вклад; исходные поля сохраняются. Перечень и native-контракты — [простые усовершенствования](docs/simple-item-upgrades-function-passport.md). 10 кандидатов поглощения ещё в работе; 11 проклятий сохраняют прежнюю автоматизацию.
