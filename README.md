...
Стопки монет можно перетаскивать из сундука на карту, в другой сундук, групповой инвентарь или лист персонажа с выбором количества. Название стопки открывает карточку монеты. На карте монеты остаются физической добычей, а при получении персонажем/группой пополняют кошелёк. Лимит строк лутгена учитывает только обычные предметы; монеты идут отдельно при общем бюджете.
