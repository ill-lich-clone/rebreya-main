...
В режиме **«Кисть выступов»** закрасьте части картинки, которым разрешено выходить за золотую границу окна. Ластик убирает разрешение на выступ, «Отменить мазок» отменяет последнее действие, «Очистить выступы» возвращает обрезку по чарнику. «Показывать скрытые части» — только подсказка редактора. Оформление ограничено 10% сверху, снизу и слева: общий габарит не превышает 120% размера чарника. Справа изображение обрезается до свободной полосы шириной 64 px для кнопок. Картинка и маска пропорционально координатам растягиваются вместе с шириной и высотой окна; движения вслед за мышью нет.
