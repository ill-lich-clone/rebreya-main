...
R7, пассивная партия 1.4.253: подключены 12 профилей КД, спасбросков, навыков, максимума хитов, ходьбы, веса и свойств доспеха. Снятие или потеря условий активности убирает собственный вклад; исходный вес и требования сохраняются. Перечень и native-контракты — [простые усовершенствования](docs/simple-item-upgrades-function-passport.md). 25 кандидатов атак/урона/поглощения ещё в работе; 11 проклятий сохраняют прежнюю автоматизацию.
