...
### Оформление чарника персонажа

В меню трёх точек листа персонажа dnd5e выберите **«Оформление чарника»**. Владелец персонажа или GM может выбрать изображение через файловый диалог либо указать путь/URL, передвинуть его в предпросмотре, изменить масштаб, прозрачность и центрирование. Лучше использовать PNG/WebP с прозрачным фоном.

Снаружи чарника изображение видно целиком, без ограничения 20% и без принудительной обрезки справа. В режиме **«Кисть внутри чарника»** разрешите выбранным частям картинки заходить внутрь золотой границы. Ластик скрывает эти участки внутри; «Очистить маску внутри» оставляет только внешнюю часть рисунка. «Отменить мазок» отменяет последнее действие. Старые мазки сохраняются, но теперь имеют эту новую семантику: при необходимости очистите маску и нарисуйте её заново.

**«Приближение вида»** (20–400%) и колесо мыши увеличивают только предпросмотр, не само оформление. Колесо приближает область под курсором. Shift + перетаскивание или режим «Перемещение вида» позволяют осмотреть нужный участок; «Сбросить вид» возвращает исходный обзор. Положение кисти учитывает приближение и перемещение. Картинка и маска растягиваются вместе с окном, параллакса нет.
**«Сохранить»** записывает только `flags.rebreya-main.sheetArt` выбранного Actor; «Отмена» оставляет его прежнее оформление. Отключение флажка **«Включено»** сохраняет картинку и маску для последующего включения. Изображение не перехватывает клики и скрывается при сворачивании окна. Пример: `modules/rebreya-main/assets/ui/character-fire-dragon.png`.
